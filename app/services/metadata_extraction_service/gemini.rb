...
class MetadataExtractionService
  ...
  class Gemini
    ...
    def from_citation(citation:, published: false)
      ...
      work_form = execute_request
      work_form.related_resource_citation = citation if published
      work_form
    end
    ...
    class FromFileRequestGenerator < RequestGenerator
      ...
      def prompt_text
        <<~TEXT
          ...
          - Remove markdown or HTML from the values. This includes characters like "*", "_", and "<>".
